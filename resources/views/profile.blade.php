    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('recruiter.update') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input disabled id="recruiter-token" type="text" class="form-control{{ $errors->has('recruiter_token') ? ' is-invalid' : '' }}" name="recruiter_token" value="{{ $user->recruiter->token }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a class="btn btn-link" href="" style="color:red">
                                    Delete account
                                </a>
                            </div>
                        </div>
